...
function NavBar() {
  return (
    <nav className="bg-white/10 z-30 rounded-md w-full max-w-7xl h-12 mx-auto flex  items-center px-5">
      <div className="flex justify-between w-full">
        <Button color="success" variant="light" className="text-3xl">
          KODE
        </Button>
...
function Footer() {
  return (
    <nav className="bg-white/10 z-20 rounded-md  mt-auto max-w-7xl h-12 mx-auto w-full flex  justify-center  items-center px-5">
      Crafted with ❤️ by{" "}
      <Link href="http://dhananjaay.dev" color="primary" className="ml-1">
        Dhananjay Senday
      </Link>
    </nav>
  );
  ...
  return (
    <html lang="en">
      <body
        className={
          inter.className +
          " dark text-foreground bg-background   flex-shrink-0  w-full"
        }
      >
        <ProviderWrapper>
          <Providers>
