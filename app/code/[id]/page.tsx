...
export default function Page({ params }: { params: { id: string } }) {
    ...
    useEffect(()=>{
        ...
        axios.get(process.env.NEXT_PUBLIC_URL+"/api/StorageEngine?id="+params.id).then((res)=>{
            let data = res.data
            setData(prev=>data)
            if (data.data==null){
...
if (isLoading) return <div className=" max-w-7xl mx-auto       grid place-content-center  h-full">
     <div className="justify-center flex flex-col items-center">
        <Skeleton className="rounded-md w-72 h-72">
...
return <><div className="max-w-7xl w-full border-2 rounded-md">
<Editor
  beforeMount={(monaco) => {
